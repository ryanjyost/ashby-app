        ...
        <main>
          <div className="main">
            <div className="left leftMain">
              <h1 style={{ color: "#fff" }}>
                Hate keeping track of your mundane adult responsibilities?
              </h1>
        ...
        >
          ...
          >
            ...
            <h5 style={{ color: "rgba(0,0,0,0.6)" }}>
              ...
              who want to save time and stress less about their
              boring-but-important adulthood responsibilities.
            </h5>
          </div>
        </div>
